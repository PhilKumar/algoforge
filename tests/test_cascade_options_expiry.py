...
class NextWeeklyExpiryTests(unittest.TestCase):
    def test_current_week_is_skipped_from_friday_and_monday(self):
        ...
        self.assertEqual(CascadeOptionsAdapter._next_expiry(expiries, date(2026, 7, 17)), date(2026, 7, 28))
        self.assertEqual(CascadeOptionsAdapter._next_expiry(expiries, date(2026, 7, 20)), date(2026, 7, 28))

    def test_holiday_shifted_monday_is_allowed_at_six_dte(self):
        expiries = [date(2026, 4, 13), date(2026, 4, 21)]
        self.assertEqual(CascadeOptionsAdapter._next_expiry(expiries, date(2026, 4, 7)), date(2026, 4, 13))
